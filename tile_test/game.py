...
class GameContext:
    def __init__(self):
        ...
        self.map_layer = pyscroll.BufferedRenderer(self.map_data, (ScreenWidth, ScreenHeight))
    ...
    def move_down(self):
        self.player_y = min(self.player_y + Speed,  10*ScreenHeight - self.player_radius)

    def move_left(self):
        self.player_x = max(self.player_radius, self.player_x - Speed)

    def move_right(self):
        self.player_x = min(self.player_x + Speed, 10*ScreenWidth - self.player_radius)
    ...
    def render(self):
        ...
        self.group.center((self.player_x, self.player_y))
